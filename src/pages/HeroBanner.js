...
const HeroBanner = () => {
    return (
        <Box sx={{
            ...
            <Typography fontSize="22px" fontWeight="630" mb="35px">Check out the most effective exercise</Typography>
            <Button variant="contained" href="#exercise" color="error" sx={{ backgroundColor: "#ff2625", padding: "15px" }}>Explore Exercise</Button>
